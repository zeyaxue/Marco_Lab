...
sample_data(ps7.merge)$Kit <- sample_data(psList[[7]])[seq(1, nrow(sample_data(psList[[7]])), 3), ]$Kit
...
KitDA <- function(ps, path.out) {
  ...
  dir.create(path.out, recursive = TRUE)
  if (nrow(resB1) > 0){
    write.csv(resB1, file.path(path.out, "resB1.csv"))
  }
  if (nrow(resV1) > 0){
    write.csv(resV1, file.path(path.out, "resV1.csv"))
  }
  if (nrow(resC1) > 0){
    write.csv(resC1, file.path(path.out, "resC1.csv"))
  }
}
...
Phase3DA <- function(ps, path.out) {
  ...
  dir.create(path.out, recursive = TRUE)
  if (nrow(resB5) > 0) write.csv(resB5, file.path(path.out, "resB5.csv"))
  if (nrow(resB5R) > 0) write.csv(resB5R, file.path(path.out, "resB5R.csv"))
  if (nrow(resC2B5) > 0) write.csv(resC2B5, file.path(path.out, "resC2B5.csv"))
  if (nrow(resC2B5R) > 0) write.csv(resC2B5R, file.path(path.out, "resC2B5R.csv"))
  if (nrow(resV3) > 0) write.csv(resV3, file.path(path.out, "resV3.csv"))
  if (nrow(resV3R) > 0) write.csv(resV3R, file.path(path.out, "resV3R.csv"))
  if (nrow(resC2V3) > 0) write.csv(resC2V3, file.path(path.out, "resC2V3.csv"))
  if (nrow(resC2V3R) > 0) write.csv(resC2V3R, file.path(path.out, "resC2V3R.csv"))
  if (nrow(resB5P) > 0) write.csv(resB5P, file.path(path.out, "resB5P.csv"))
  if (nrow(resB5RP) > 0) write.csv(resB5RP, file.path(path.out, "resB5RP.csv"))
  if (nrow(resC2B5P) > 0) write.csv(resC2B5P, file.path(path.out, "resC2B5P.csv"))
  if (nrow(resC2B5RP) > 0) write.csv(resC2B5RP, file.path(path.out, "resC2B5RP.csv"))
  if (nrow(resV3P) > 0) write.csv(resV3P, file.path(path.out, "resV3P.csv"))
  if (nrow(resV3RP) > 0) write.csv(resV3RP, file.path(path.out, "resV3RP.csv"))
  if (nrow(resC2V3P) > 0) write.csv(resC2V3P, file.path(path.out, "resC2V3P.csv"))
  if (nrow(resC2V3RP) > 0) write.csv(resC2V3RP, file.path(path.out, "resC2V3RP.csv"))
}

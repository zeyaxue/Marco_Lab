...
calculate_rarefaction_curves <-dget(file.path("D:/src/Marco_Lab/Cheese1_R/FUN_calculate_rarefaction.R"))
...
RECps <- dget("D:/src/Marco_Lab/Cheese1_R/FUN_RECps.R") # Read in RECps function
